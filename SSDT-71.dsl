 ...
 *
 * Disassembly of SSDT-7.aml, Tue Aug 15 03:01:29 2017
 *
...
DefinitionBlock ("", "SSDT", 1, "SgRef", "SgTabl", 0x00001000)
{
    ...
    External (_SB_.PCI0.IGPU.DD01._DCS, MethodObj)    // 0 Arguments
    ...
    External (_SB_.PCI0.IGPU.HDSM, IntObj)    // Warning: Unknown object
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        ...
        Device (DD01)
        {
            ...
            {
                Return (\_SB.PCI0.IGPU.DD01._DCS ())
            }
        ...
        Device (DD03)
        {
            ...
            Method (_DCS, 0, NotSerialized)  // _DCS: Display Current Status
            {
                Return (\_SB.PCI0.IGPU.DD03._DCS ())
            }
        ...
        Device (DD04)
        {
            ...
            Method (_DCS, 0, NotSerialized)  // _DCS: Display Current Status
            {
                Return (\_SB.PCI0.IGPU.DD04._DCS ())
            }
        ...
        Device (DD05)
        {
            ...
            Method (_DCS, 0, NotSerialized)  // _DCS: Display Current Status
            {
                Return (\_SB.PCI0.IGPU.DD05._DCS ())
            }
        ...
        Device (DD06)
        {
            ...
            Method (_DCS, 0, NotSerialized)  // _DCS: Display Current Status
            {
                Return (\_SB.PCI0.IGPU.DD06._DCS ())
            }
        ...
        Device (DD07)
        {
            ...
            Method (_DCS, 0, NotSerialized)  // _DCS: Display Current Status
            {
                Return (\_SB.PCI0.IGPU.DD07._DCS ())
            }
        ...
        Device (DD08)
        {
            ...
            Method (_DCS, 0, NotSerialized)  // _DCS: Display Current Status
            {
                Return (\_SB.PCI0.IGPU.DD08._DCS ())
            }
